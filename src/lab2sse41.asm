...
../lab2sse41:     file format elf64-x86-64
...
0000000000400816 <componentwise_multiply_real_sse4>:
  400816:	41 89 c8             	mov    r8d,ecx
  400819:	66 85 c9             	test   cx,cx
  40081c:	74 20                	je     40083e <componentwise_multiply_real_sse4+0x28>
  40081e:	b8 00 00 00 00       	mov    eax,0x0
  400823:	0f b7 c8             	movzx  ecx,ax
  400826:	66 0f 6f 04 4f       	movdqa xmm0,XMMWORD PTR [rdi+rcx*2]
  40082b:	66 0f 38 0b 04 4e    	pmulhrsw xmm0,XMMWORD PTR [rsi+rcx*2]
  400831:	0f 29 04 4a          	movaps XMMWORD PTR [rdx+rcx*2],xmm0
  400835:	83 c0 08             	add    eax,0x8
  400838:	66 41 39 c0          	cmp    r8w,ax
  40083c:	77 e5                	ja     400823 <componentwise_multiply_real_sse4+0xd>
  40083e:	f3 c3                	repz ret 
...
0000000000400840 <main>:
  ...
  4009ba:	e8 57 fe ff ff       	call   400816 <componentwise_multiply_real_sse4>
