...
../lab2avx22:     file format elf64-x86-64
...
0000000000400720 <main>:
  ...
  4007db:	eb 0d                	jmp    4007ea <main+0xca>
  4007dd:	0f 1f 00             	nop    DWORD PTR [rax]
  4007e0:	66 45 39 fc          	cmp    r12w,r15w
  4007e4:	73 20                	jae    400806 <main+0xe6>
  4007e6:	41 83 c4 01          	add    r12d,0x1
  4007ea:	48 8b 7d c8          	mov    rdi,QWORD PTR [rbp-0x38]
